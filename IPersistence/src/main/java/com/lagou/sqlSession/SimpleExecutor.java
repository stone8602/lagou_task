...
public class SimpleExecutor implements  Executor {
    ...
    public <E> List<E> query(Configuration configuration, MappedStatement mappedStatement, Object... params) throws Exception {
        PreparedStatement preparedStatement=init(configuration,mappedStatement,params);
        // 5. 执行sql
    ...
    private PreparedStatement init(Configuration configuration,MappedStatement mappedStatement, Object... params) throws SQLException, ClassNotFoundException, NoSuchFieldException, IllegalAccessException {
        // 1. 注册驱动，获取连接
